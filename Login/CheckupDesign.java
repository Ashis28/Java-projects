...
//            System.out.println(a[0]);
     ...
     */
        ...
        void saveAllRData()   //saving all billing info data
    {
        try
        {
            ...
            {
                filewriter.write(record.get(i).getPatientId()+";"+record.get(i).getFee()+";"+record.get(i).getRecomendation()+";"+
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(734, 591));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        else
        {
            ...
            for(int i=0;i<Mdata.length;i++)
            {
                ...
                System.out.println(currQ+" "+currId);
                for(int j=0;j<allMedicines.size();j++)
                {
                    if(allMedicines.get(j).getId()==currId)
                    {
                        ...
                        allMedicines.get(j).setQuantity(allMedicines.get(j).getQuantity()-currQ);
                    }
                }
            }
            ...
            saveAllMData();
            saveAllRData();
            Bill+="\n Total Med Cost = "+total;
            Bill+="\n TOtal Doctor Fee"+ fee.getText();
            Bill+="\n Total = " + (total+Integer.parseInt(fee.getText()));
            JOptionPane.showMessageDialog(null,"Saved successifully"+Bill);
            id.setText("");
            fee.setText("");
            rec.setText("");
            mList.setText("");
